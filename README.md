...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 3c778302-c418-4bc0-9b49-2e3a8371acac
```

> `3c778302-c418-4bc0-9b49-2e3a8371acac` is the password of the certificate, you can change it to any password you want.
