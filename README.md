...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 226c115c-caff-4e98-bcee-f3ba61d35130
```

> `226c115c-caff-4e98-bcee-f3ba61d35130` is the password of the certificate, you can change it to any password you want.
